...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_886a88be922330beef507a2efd7e9a42a1486451": function($0, $1, $2) {
                Module.STDWEB.from_js($0, (function(){Module.exports.requestProject = Module.STDWEB.to_js($1); Module.exports.parseMessage = Module.STDWEB.to_js($2);})());
            },
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.websocket_api_web.exports = Module.exports;
        }
    ...
    const __promise = fetch("/wasm/websocket_api_web.wasm")
        ...
        .catch(error => {
            console.log("Error loading Rust wasm module 'websocket_api_web':", error);
            throw error;
        });

    Rust.websocket_api_web = __promise;
    return __promise;
}));
